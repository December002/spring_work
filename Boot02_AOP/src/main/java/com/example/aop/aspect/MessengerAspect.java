...
public class MessengerAspect {
	...
	public void checkGreeting(ProceedingJoinPoint joinPoint) throws Throwable {
		...
		//aspect 가 적용된 메소드가 호출되기 직전에 해야 할 작업은 proceed() 호출 전에 한다.
		...
		System.out.println("aspect 가 적용된 메소드가 리턴되었습니다.");
	...
	public Object checkReturn(ProceedingJoinPoint joinPoint) throws Throwable {
		...
		//원래 type 으로 casting 해서 조사해 볼 수 가 있다.
		String a = (String)obj;
		
		//조사후 아예 다른 값으로 리턴해 줄 수도 있다.
		//return obj;
		return "놀자놀자";
	}
}
