 ...
 * 
 * 	SmartEditor /photo_uploader/popup/attach_photo.sj 에 있는 코드를
 * 
 * 	아래와 같이 수정해야 한다.
 * 
 * 
   ...
   여기서 /boot07 은 context path 이기 때문에 상항에 맞게 변경해야 한다.
 * 
 */
...
public class SmartEditorController {
	...
	public byte[] editorImage(@PathVariable("imageName")String imageName) throws IOException {
		...
		//이미지 (byte) 를 읽어서 배열에 담아서 클라이언트 한테 응답한다.
